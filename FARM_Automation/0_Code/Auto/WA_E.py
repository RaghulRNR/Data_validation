...
#conditions:-
    ...
    merged['tc45'] = np.where(
        (merged['TableDesignation'] == '36.C.5.a.(2)') & (merged['causes_of_loss'] == '') & (merged['zone'] == z1) & (
                    merged['prop_cov'] == 'e_and_farm_inland_marine') & (
    ...
    merged['tc162'] = np.where(
        (merged['TableDesignation'] == '36.C.5.a.(2)') & (merged['causes_of_loss'] == 'basic') & (
                    merged['zone'] == z1) & (merged['prop_cov'] == 'e_and_farm_inland_marine') & (
                    merged['prop_type'] == 'potatoes'), merged['Value'], 0.00)
    ...
    merged['tc171'] = np.where(
        (merged['TableDesignation'] == '36.C.5.a.(2)') & (merged['causes_of_loss'] == 'basic') & (
                    merged['zone'] == z1) & (merged['prop_cov'] == 'e_and_farm_inland_marine') & (
                    merged['prop_type'] == 'green_fruit_in_cold_storage_warehouses_and_or_packing_buildings_etc'),
        merged['Value'], 0.00)
    ...
    def format_align(temp_table):
        ...
        test_table_AC['tc180'] = test_table_AC["tc180"].str.pad(322, side='left')
