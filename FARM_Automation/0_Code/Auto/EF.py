...
def EF(zone, Sorting):
    ...
    def format_align(temp_table):
        ...
        test_table_AC['tc207'] = test_table_AC["tc207"].str.pad(133, side='left')
    ...
    np.savetxt(farm_op + clms_fol_name + '\\TABLE_EF_' + zone + '.txt', test_clms_table_D.values, fmt="%s",
               delimiter='')
    np.savetxt(farm_op + eips_fol_name + '\\TABLE_EF_' + zone + '.txt', test_eips_table_D.values, fmt="%s",
               delimiter='')
