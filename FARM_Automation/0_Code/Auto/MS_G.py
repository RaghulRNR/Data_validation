...
def MS_G(zone, Sorting):
    ...
    merged['tc144'] = np.where(
        (merged['TableDesignation'] == '36.C.5.a.(3)') & (merged['causes_of_loss'] == 'basic') & (
                    merged['prop_cov'] == 'g') & (merged['zone'] == z1) & (
                    merged['prop_type'] == 'all_metal_tanks_used_only_for_threshed_grain_and_seed'), merged['Value'],
        0.00)
    ...
    merged['tc153'] = np.where(
        (merged['TableDesignation'] == '36.C.5.a.(3)') & (merged['causes_of_loss'] == 'basic') & (
                    merged['prop_cov'] == 'g') & (merged['zone'] == z1) & (merged['prop_type'] == 'offices'),
        merged['Value'], 0.00)
    merged['tc154'] = np.where(
        (merged['TableDesignation'] == '36.C.5.a.(3)') & (merged['causes_of_loss'] == 'basic') & (
                    merged['prop_cov'] == 'g') & (merged['zone'] == z2) & (merged['prop_type'] == 'offices'),
        merged['Value'], 0.00)
    merged['tc155'] = np.where(
        (merged['TableDesignation'] == '36.C.5.a.(3)') & (merged['causes_of_loss'] == 'basic') & (
                    merged['prop_cov'] == 'g') & (merged['zone'] == z3) & (merged['prop_type'] == 'offices'),
        merged['Value'], 0.00)
    ...
    merged['tc162'] = np.where(
        (merged['TableDesignation'] == '36.C.5.a.(3)') & (merged['causes_of_loss'] == 'basic') & (
                    merged['prop_cov'] == 'g') & (merged['zone'] == z1) & (merged['prop_type'] == 'fish_hatcheries'),
        merged['Value'], 0.00)
    merged['tc163'] = np.where(
        (merged['TableDesignation'] == '36.C.5.a.(3)') & (merged['causes_of_loss'] == 'basic') & (
                    merged['prop_cov'] == 'g') & (merged['zone'] == z2) & (merged['prop_type'] == 'fish_hatcheries'),
        merged['Value'], 0.00)
    merged['tc164'] = np.where(
        (merged['TableDesignation'] == '36.C.5.a.(3)') & (merged['causes_of_loss'] == 'basic') & (
                    merged['prop_cov'] == 'g') & (merged['zone'] == z3) & (merged['prop_type'] == 'fish_hatcheries'),
        merged['Value'], 0.00)
    ...
    def format_align(temp_table):
        ...
        test_table_AC['tc171'] = test_table_AC["tc171"].str.pad(385, side='left')
